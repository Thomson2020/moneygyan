...
useEffect(() => {
  ...
  const updateTheme = () => {
    // Check if the HTML element does NOT have the "light" class (meaning it's dark by default)
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      const newThemeIsDark = isDark // current isDark before toggle
      // Toggle "light" class on document.documentElement
      const willBeLight = document.documentElement.classList.toggle("light")
      const newTheme = willBeLight ? "light" : "dark"
