...
void main() {
  ...
  float fadeBottom = smoothstep(-(uEdgeFadeWidth + 0.4), -uEdgeFadeWidth, blended.y);
  float vMask = (1.0 - fadeTop) * fadeBottom;
...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 },
        uResolution: { value: [gl.canvas.width || window.innerWidth, gl.canvas.height || window.innerHeight, (gl.canvas.width || 1) / (gl.canvas.height || 1)] },
        uSpeed: { value: speed },
